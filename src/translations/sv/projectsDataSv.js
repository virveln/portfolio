...
// Använd import.meta.glob för att importera alla bilder i de specifika mapparna
// const graphicProfileImages = import.meta.glob('../../images/graphicprofile/*.{png,jpeg,jpg,svg}', { eager: true });
// const magasindesignImages = import.meta.glob('../../images/magasindesign/*.{png,jpeg,jpg,svg}', { eager: true });
// const hammaroadventureImages = import.meta.glob('../../images/hammaroadventure/*.{png,jpeg,jpg,svg}', { eager: true });
// const cocktailsanddreamsImages = import.meta.glob('../../images/cocktailsanddreams/*.{png,jpeg,jpg,svg}', { eager: true });
// const brunchncrunchImages = import.meta.glob('../../images/brunchncrunch/*.{png,jpeg,jpg,svg}', { eager: true });
// const showcaseImages = import.meta.glob('../../images/showcase/*.{png,jpeg,jpg,svg}', { eager: true });
// const hangmanImages = import.meta.glob('../../images/hangman/*.{png,jpeg,jpg,svg}', { eager: true });
// const businessSystemImages = import.meta.glob('../../images/affarssystem/*.{png,jpeg,jpg,svg}', { eager: true });
// const nollningsmarkenImages = import.meta.glob('../../images/nollningsmarken/*.{png,jpeg,jpg,svg,JPG}', { eager: true });
// const nollningsbiblarImages = import.meta.glob('../../images/nollningsbiblar/*.{png,jpeg,jpg,svg,JPG}', { eager: true });
// const jeopardyImages = import.meta.glob('../../images/jeopardy/*.{png,jpeg,jpg,svg}', { eager: true });
// const todoImages = import.meta.glob('../../images/todo/*.{png,jpeg,jpg,svg}', { eager: true });
