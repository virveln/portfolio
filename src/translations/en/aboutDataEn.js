const aboutData = [
    {
        contactInfo: {
            linkedin: 'https://www.linkedin.com/in/jessica-hvirfvel/',
            linkedinTitle: 'linkedin.com/in/jessica-hvirfvel',
            mail: 'mailto:jessica.hvirfvel@hotmail.com',
        ...
        introduction: {
            ...
            p2: 'Fast forward to today, I hold a Bachelor of Science degree in Information Systems from Karlstads University, and I\'m fully interested in full-stack development.',
            p3: 'Let\'s connect!'
        },
        funfacts: [
            {
        ...
        experience: [
            ...
            {
                title: 'System Development, OOP and Business Systems',
                language: [
                    'C',
                    'C#',
                    '.NET',
